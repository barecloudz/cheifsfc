  ...
  return (
    <div className="fut-card">
      ...
      <div className="fut-card-content">
        ...
        <div className="absolute top-[12%] left-[15%] flex flex-col items-center z-10">
        ...
        <div className="absolute top-[10%] left-[30%] right-[15%] bottom-[44%] overflow-hidden">
          {imageUrl ? (
            <Image
              src={imageUrl}
              alt={name}
        ...
        <div className="absolute top-[56%] left-[16%] right-[16%] bottom-[12%] flex flex-col items-center">
          {/* Divider */}
